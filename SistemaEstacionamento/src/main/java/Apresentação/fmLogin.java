...
public class fmLogin extends javax.swing.JFrame {
    ...
    private String usuarioDefault = "user";
    private String senhaDefault = "123";
    
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        String usuario = txtUsuario.getText().trim();
        String senha = new String(txtSenha.getPassword());
        
        // Comparar dados de entrada com usuario e senha padrão
        if(usuario.equals(usuarioDefault) && senha.equals(senhaDefault)){
            // Criamos uma instancia do formulário principal
